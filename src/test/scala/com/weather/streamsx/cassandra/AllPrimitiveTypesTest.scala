...
//    received shouldBe valuesMap +- 0.0000001
    ...
    received("decimal32").asInstanceOf[scala.BigDecimal] shouldBe valuesMap("decimal32").asInstanceOf[scala.BigDecimal] +- 0.000001
    received("decimal64").asInstanceOf[scala.BigDecimal] shouldBe valuesMap("decimal64").asInstanceOf[scala.BigDecimal] +- 0.000001
    received("decimal128").asInstanceOf[scala.BigDecimal] shouldBe valuesMap("decimal128").asInstanceOf[scala.BigDecimal]  +- 0.000001
