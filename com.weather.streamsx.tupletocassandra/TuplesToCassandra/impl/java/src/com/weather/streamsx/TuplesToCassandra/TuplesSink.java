/* Generated by Streams Studio: June 6, 2016 at 7:36:21 PM EDT */
 ...
 */
@PrimitiveOperator(name="TuplesSink", namespace="com.weather.streamsx.TuplesToCassandra",
description="Java Operator TuplesSink")
@InputPorts({@InputPortSet(description="Port that ingests tuples", cardinality=1, optional=false, windowingMode=WindowMode.NonWindowed, windowPunctuationInputMode=WindowPunctuationInputMode.Oblivious), @InputPortSet(description="Optional input ports", optional=true, windowingMode=WindowMode.NonWindowed, windowPunctuationInputMode=WindowPunctuationInputMode.Oblivious)})
public class TuplesSink extends AbstractOperator {
